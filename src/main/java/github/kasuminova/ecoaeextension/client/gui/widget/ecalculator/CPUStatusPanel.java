...
public class CPUStatusPanel extends SizedColumn {
    ...
    public static class CPUStatus extends SizedRow {
        ...
        public CPUStatus(final ECalculatorData.ThreadCoreData core) {
            ...
            switch (core.type()) {
                case L4: overlay = hyper ? getOverlaySprite(L4_HYPER, working) : getOverlaySprite(L4, working); break;
                case L6: overlay = hyper ? getOverlaySprite(L6_HYPER, working) : getOverlaySprite(L6, working); break;
                case L9: overlay = hyper ? getOverlaySprite(L9_HYPER, working) : getOverlaySprite(L9, working); break;
                default: overlay = null; break;
            }
