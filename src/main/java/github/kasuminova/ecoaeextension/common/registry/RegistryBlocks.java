...
public class RegistryBlocks {
    ...
    public static void registerBlocks() {
        ...
        registerCustomItemBlock(BlockEStorageEnergyCell.L4, ItemBlockEStorageEnergyCell.class);
        registerCustomItemBlock(BlockEStorageEnergyCell.L6, ItemBlockEStorageEnergyCell.class);
        registerCustomItemBlock(BlockEStorageEnergyCell.L9, ItemBlockEStorageEnergyCell.class);
