...
public class ECellDriveWatcher<T extends IAEStack> extends MEInventoryHandler<T> {

    protected final EStorageCellDrive drive;

    public ECellDriveWatcher(final IMEInventory i, final IStorageChannel channel, final EStorageCellDrive drive) {
        super(i, channel);
        this.drive = drive;
    }
