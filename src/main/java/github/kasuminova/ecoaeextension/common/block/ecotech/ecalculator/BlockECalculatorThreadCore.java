...
public class BlockECalculatorThreadCore extends BlockECalculatorPart {
    ...
    protected BlockECalculatorThreadCore(final String unlocalizedName, final int threads, final int hyperThreads) {
        super(Material.iron);
    ...
    public void breakBlock(@Nonnull final World worldIn, final int x, final int y, final int z, @Nonnull final Block block, final int meta) {
        ...
        if (te == null || worldIn.isRemote) {
            dropBlockAsItem(worldIn, x, y, z, dropped);
        ...
        ECalculatorThreadCore threadCore = (ECalculatorThreadCore) te;
